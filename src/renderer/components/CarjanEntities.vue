      ...
      <template #content>
        <div class="stats-grid">
          <div class="stat-item">
            ...
            <div class="stat-info">
              <span class="stat-value">{{ getEntityCount("pedestrian") }}</span>
          ...
          <div class="stat-item">
            <i class="pi pi-car"></i>
            <div class="stat-info">
              <span class="stat-value">{{ getEntityCount("vehicle") }}</span>
          ...
          <div class="stat-item">
            <i class="pi pi-cog"></i>
            <div class="stat-info">
              <span class="stat-value">{{ getEntityCount("autonomous") }}</span>
          ...
          <div class="stat-item">
            ...
            <div class="stat-info">
              <span class="stat-value">{{ getEntityCount("obstacle") }}</span>
